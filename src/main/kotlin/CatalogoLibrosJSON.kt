...
class CatalogoLibrosJSON(val cargador:String): CatalogoLibrosInterface
{

    private var libros: List<Book> = cargador.fromJson<List<Book>>()
    ...
    override fun infoLibro(idLibro: String): Map<String, Any> {
        val book = libros.first{ it.id == idLibro }
